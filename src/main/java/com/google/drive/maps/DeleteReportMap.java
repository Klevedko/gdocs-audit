...
public class DeleteReportMap implements Serializable, Comparable<DeleteReportMap> {
    private String id;
    ...
    public DeleteReportMap(String id, String folderName, String name, String webViewLink, String parentFolderId) {
        this.id = id;
    ...
    public boolean equals(Object obj) {
        DeleteReportMap that = (DeleteReportMap) obj;
    ...
    @Override
    public int compareTo(DeleteReportMap o) {
