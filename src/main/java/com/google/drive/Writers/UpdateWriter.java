...
public class UpdateWriter extends UpdateReport {
    public static String audit_date = new SimpleDateFormat("dd-MM-yyyy").format(new Date());

    public static void write_to_file(ArrayList<UpdateReportMap> updateReportMap) {
        try {
            ...
            cs.setWrapText(true);
            for (UpdateReportMap product : updateReportMap) {
                Row dataRow;
    ...
    public static void write_errors_to_file(ArrayList<UpdateReportErrorMap> updateReportErrorMap) {
        try {
            ...
            errorRow++;
            for (UpdateReportErrorMap errors : updateReportErrorMap) {
