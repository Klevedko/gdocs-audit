...
public class StaticReportMap implements Serializable, Comparable<StaticReportMap> {
    private String id;
    ...
    public boolean equals(Object obj) {
        StaticReportMap that = (StaticReportMap) obj;
    ...
    @Override
    public int compareTo(StaticReportMap o) {
